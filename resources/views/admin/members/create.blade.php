    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.members.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_surname') ? 'is-invalid' : '' }}" type="text" name="name_surname" id="name_surname" value="{{ old('name_surname', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birthyear') ? 'is-invalid' : '' }}" type="text" name="birthyear" id="birthyear" value="{{ old('birthyear') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('derbis') ? 'is-invalid' : '' }}" name="derbis" id="derbis">
                    ...
                    @foreach(App\Models\Member::DERBIS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('derbis', 'pasif') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Member::DURUM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('durum') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="durum_{{ $key }}" name="durum" value="{{ $key }}" {{ old('durum', 'aktif') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('registration') ? 'is-invalid' : '' }}" type="text" name="registration" id="registration" value="{{ old('registration') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('decision_date') ? 'is-invalid' : '' }}" type="text" name="decision_date" id="decision_date" value="{{ old('decision_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numberdecisions') ? 'is-invalid' : '' }}" type="number" name="numberdecisions" id="numberdecisions" value="{{ old('numberdecisions', '') }}" step="1">
